...
import com.sos.jobscheduler.core.filebased.{FileBasedConfigurationReader, FileBaseds, Repo}
...
/**
  ...
  */
protected[master] trait MasterRepoReader extends FileBasedConfigurationReader
{

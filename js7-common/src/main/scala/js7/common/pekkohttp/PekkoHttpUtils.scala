...
object PekkoHttpUtils
{
  /** Try to avoid lazy object initialization deadlock in `HttpEntity`.
    ...
    * pekko.http.javadsl.model.HttpEntity$ChunkStreamPart.&lt;clinit>(HttpEntity.java:325)
    * pekko.http.scaladsl.model.HttpEntity$Chunked$$anonfun$fromData$1.applyOrElse(HttpEntity.scala:562)
    * pekko.http.scaladsl.model.HttpEntity$Chunked$$anonfun$fromData$1.applyOrElse(HttpEntity.scala:561)
    * </pre>
    */

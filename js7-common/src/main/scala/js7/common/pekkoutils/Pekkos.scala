...
import org.apache.pekko.actor.{ActorContext, ActorPath, ActorSystem, ChildActorPath, RootActorPath, Terminated}
...
object Pekkos
{
  ...
  = {
    ...
    ActorSystem(
      ...
      myConfig.getBoolean("js7.pekko.use-js7-thread-pool") ? defaultExecutionContext)
  }

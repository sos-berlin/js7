...
import org.apache.pekko.actor.{Actor, ActorSystem, DeadLetter, DeadLetterSuppression, Props, ReceiveTimeout, UnhandledMessage}
...
object DeadLetterActor
{
  ...
  private def messageToLogLevel(message: Any): LogLevel =
    message match {
      case _: org.apache.pekko.io.Tcp.Write => Debug

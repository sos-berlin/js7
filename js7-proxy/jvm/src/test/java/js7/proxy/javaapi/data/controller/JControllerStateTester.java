...
import js7.proxy.javaapi.data.order.JOrderTester;
import js7.proxy.javaapi.data.workflow.JWorkflowId;
import js7.proxy.javaapi.data.workflow.JWorkflowTester;
...
import static js7.proxy.javaapi.data.order.JOrderTester.bOrder;

...
import com.sos.jobscheduler.shared.event.journal.GzipCompression.isGzipCompressed
import com.sos.jobscheduler.shared.event.journal.GzipCompressionTest._

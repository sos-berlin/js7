...
/**
  ...
  */
final class KeyedEventTypedJsonCodec[E <: Event](
  val classToEncoder: Map[Class[_], Encoder[KeyedEvent[_ <: E]]],
  val nameToDecoder: Map[String, Decoder[KeyedEvent[_ <: E]]],
  val nameToClass: Map[String, Class[_ <: E]])
extends Encoder[KeyedEvent[E]]
   with Decoder[KeyedEvent[E]] {

  def apply(keyedEvent: KeyedEvent[E]): Json =
    keyedEvent.asJson(encoder = classToEncoder(keyedEvent.event.getClass))
...
object KeyedEventTypedJsonCodec {
  ...
  def apply[E <: Event: ClassTag](subtypes: KeyedSubtype[_ <: E]*) = {
    ...
    new KeyedEventTypedJsonCodec[E](
      subtypes.flatMap(_.classToEncoder mapValues (_.asInstanceOf[Encoder[KeyedEvent[E]]])).uniqueToMap withDefault (o ⇒ throw new UnknownClassForJsonException(o, cls)),
  ...
  final class KeyedSubtype[E <: Event](
    ...
    implicit val encoder: Encoder[KeyedEvent[E]],
  ...
  object KeyedSubtype {
    ...
    def singleEvent[E <: Event: ClassTag](implicit ke: Encoder[E#Key], kd: Decoder[E#Key], eventEncoder: Encoder[E], eventDecoder: Decoder[E]): KeyedSubtype[E] = {
    ...
    def of[E <: Event: ClassTag](name: String)(implicit ke: Encoder[E#Key], kd: Decoder[E#Key], codec: TypedJsonCodec[E]): KeyedSubtype[E] = {
      new KeyedSubtype[E](
        classToEncoder = codec.classToEncoder.mapValues { encoder ⇒
          implicit val x = encoder.asInstanceOf[Encoder[E]]

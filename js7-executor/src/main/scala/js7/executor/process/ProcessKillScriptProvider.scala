...
import js7.executor.process.ProcessKillScriptProvider._
...
object ProcessKillScriptProvider {
  ...
  private val WindowsScriptResource = JavaResource("js7/executor/process/scripts/windows/kill_task.cmd")
  private val UnixScriptResource = JavaResource("js7/executor/process/scripts/unix/kill_task.sh")
}

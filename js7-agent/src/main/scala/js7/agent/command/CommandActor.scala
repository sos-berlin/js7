...
import js7.agent.data.commands.AgentCommand.{Batch, CoupleController, EmergencyStop, NoOperation, OrderCommand, RegisterAsController, Response, ShutDown, TakeSnapshot}
...
extends Actor {
  ...
  =
    command match {
      ...
      case command @ (_: OrderCommand | _: RegisterAsController | _: CoupleController | _: TakeSnapshot.type | _: ShutDown) =>

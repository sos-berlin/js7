...
import js7.agent.data.commands.AgentCommand.{AttachSimpleItem, Batch, CoupleController, EmergencyStop, NoOperation, OrderCommand, RegisterAsController, Response, ShutDown, TakeSnapshot}
  ...
  =
    command match {
      ...
      case command @ (_: OrderCommand | _: RegisterAsController | _: CoupleController |
                      _: TakeSnapshot.type | _: AttachSimpleItem | _: ShutDown) =>

  ...
  "Sleep at start, at Controller" in:
    ...
    withItem(workflow): workflow =>
      ...
      assert(eventWatch.eventsByKey[OrderEvent](orderId) == Seq(
        ...
        OrderStarted,
        OrderSleeping(until = ts"2024-12-18T12:00:03Z", OrderSleeping.Cause.SleepInstruction),
  ...
  "Sleep after start, at Agent" in:
    ...
    withItem(workflow): workflow =>
      ...
      assert(eventWatch.eventsByKey[OrderEvent](orderId) == Seq(
        ...
        OrderMoved(Position(1)),
        OrderSleeping(until = ts"2024-12-18T13:00:03Z", OrderSleeping.Cause.SleepInstruction),
        OrderMoved(Position(2)),
        OrderDetachable,
        OrderDetached,
        OrderFinished(),
  ...
  "GoOrder" in:
    ...
    withItem(workflow): workflow =>
      ...
      assert(eventWatch.eventsByKey[OrderEvent](orderId) == Seq(
        ...
        OrderProcessed(OrderOutcome.succeeded),
        OrderMoved(Position(1)),
        OrderSleeping(until = ts"2024-12-18T14:00:03Z", OrderSleeping.Cause.SleepInstruction),
  ...
  "SuspendOrders with reset" in:
    ...
    withItem(workflow): workflow =>
      ...
      assert(eventWatch.eventsByKey[OrderEvent](orderId) == Seq(
        ...
        OrderProcessed(OrderOutcome.succeeded),
        OrderMoved(Position(1)),
        OrderSleeping(until = ts"2024-12-18T15:00:03Z", OrderSleeping.Cause.SleepInstruction),
        ...
        OrderSuspended,
        OrderResumed(),
        OrderSleeping(until = ts"2024-12-18T15:00:04Z", OrderSleeping.Cause.SleepInstruction),
        OrderMoved(Position(2)),
        OrderFinished(),
        OrderDeleted))

...
import js7.data.order.OrderEvent.{OrderAdded, OrderAwoke, OrderCaught, OrderFailed, OrderMoved, OrderRetrying, OrderStarted, OrderStepFailed, OrderTerminated}
    ...
    withTemporaryItem(workflow) { workflow =>
      ...
      assert(eventWatch.allStamped[OrderEvent]
        ...
        Seq(
          ...
          start -> OrderStarted,
          start -> OrderStepFailed(Outcome.failed),

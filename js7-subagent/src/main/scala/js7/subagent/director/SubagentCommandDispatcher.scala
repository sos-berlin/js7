...
import js7.subagent.director.SubagentCommandDispatcher.*

private final class SubagentCommandDispatcher(
...
extends CommandDispatcher:
  ...
  override def toString = s"SubagentCommandDispatcher($name)"


private object SubagentCommandDispatcher:

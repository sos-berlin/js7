...
import js7.base.utils.ScalaUtils.syntax.{RichBoolean, foreachWithBracket}
...
final case class EventColl[S <: EventDrivenState[S, E], E <: Event, Ctx] private(
  ...
  //def computeEvent(toEvent: S => Checked[KeyedEvent[E]]): Checked[EventColl[S, E, Ctx]] =
  ...
  : Checked[EventColl[S, E, Ctx]] =
    val eventSeq = keyedEvents match

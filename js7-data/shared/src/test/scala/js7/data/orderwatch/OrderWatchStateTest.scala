...
import js7.data.orderwatch.OrderWatchState.{Appeared, AppearedOrHasOrder, ExternalOrderSnapshot, HasOrder, Vanished}
...
final class OrderWatchStateTest extends OurAsyncTestSuite:
  ...
  private val orderWatchState =
    OrderWatchState(
      ...
      Map( // Not in snapshot, because its duplicate to Order.externalOrder
        ExternalOrderName("A-NAME") -> Appeared(OrderId("A-ORDER"), NamedValues("K" -> StringValue("V"))),
        ...
        ExternalOrderName("D-NAME") -> HasOrder(OrderId("D-ORDER"), Some(Appeared(OrderId("D-ORDER"), NamedValues("K" -> StringValue("V2")))))),
  ...
  "JSON" - {
    "AppearedOrHasOrder" in:
      testJson[AppearedOrHasOrder](Appeared(OrderId("ORDER"), Map("file" -> StringValue("FILE"))),
        json"""{
          "TYPE": "Appeared",
          "orderId": "ORDER",
          "arguments": {
      ...
      testJsonDecoder[AppearedOrHasOrder](Appeared(OrderId("ORDER"), Map("file" -> StringValue("FILE"))),
        json"""{
          "TYPE": "Arised",
          "orderId": "ORDER",
          "arguments": {
      ...
      testJson[AppearedOrHasOrder](
        HasOrder(
          OrderId("ORDER"),
          Some(Appeared(OrderId("ORDER"), Map("file" -> StringValue("FILE"))))),
        json"""{
          "TYPE": "HasOrder",
          "orderId": "ORDER",
          "queued": {
      ...
      testJsonDecoder[AppearedOrHasOrder]( // COMPATIBLE with v2.7.3
        HasOrder(
          OrderId("ORDER"),
          Some(Appeared(OrderId("ORDER"), Map("file" -> StringValue("FILE"))))),
        json"""{
    ...
    "ExternalOrderSnapshot" in:
      testJson[OrderWatchState.Snapshot](
        ExternalOrderSnapshot(
          ...
          Appeared(OrderId("ORDER"), NamedValues("file" -> StringValue("FILE")))),
        json"""{
          "TYPE": "ExternalOrder",
          "externalOrderName": "FILE",
          "orderWatchPath": "FILE-WATCH",

...
final class JavaTimestampTest extends OurTestSuite:
  ...
  "parse" in:
    assert(Timestamp("2021-08-29T22:00:00Z") == timestamp)
    assert(Timestamp("2021-08-29T22:00:00.1Z") == timestamp + 100.ms)
    assert(Timestamp("2021-08-29T22:00:00.001Z") == timestamp + 1.ms)
    assert(Timestamp("2021-08-29T22:00:00.999Z") == timestamp + 999.ms)
    assert(Timestamp("2021-08-29T22:00:00.999999Z") == timestamp + 999.ms)

  "toString" in:
    assert(Timestamp("1960-01-01T00:00:00Z").toString == "1960-01-01T00:00:00Z")
    assert(Timestamp("1960-12-31T23:59:59.999Z").toString == "1960-12-31T23:59:59.999Z")
    assert(Timestamp("2021-08-29T22:00:00Z").toString == "2021-08-29T22:00:00Z")
    assert(Timestamp("2021-08-29T22:00:00.1Z").toString == "2021-08-29T22:00:00.100Z")
    assert(Timestamp("2021-08-29T22:00:00.999Z").toString == "2021-08-29T22:00:00.999Z")

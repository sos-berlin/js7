...
final class ByteUnitsTest extends OurTestSuite
{
  "formatNumber" in {
    ...
    assert(formatNumber(1199, 1000, "x") == "1.1x")
    assert(formatNumber(1900, 1000, "x") == "1.9x")
    assert(formatNumber(1999, 1000, "x") == "1.9x")
    assert(formatNumber(2000, 1000, "x") == "2x")
    assert(formatNumber(2099, 1000, "x") == "2x")
    assert(formatNumber(2900, 1000, "x") == "2.9x")
    assert(formatNumber(2999, 1000, "x") == "2.9x")
    assert(formatNumber(9999, 1000, "x") == "9.9x")
    assert(formatNumber(10000, 1000, "x") == "10x")
    assert(formatNumber(10100, 1000, "x") == "10x")
    ...
    assert(formatNumber(1024+102, 1024, "x") == "1x")
    assert(formatNumber(1024+103, 1024, "x") == "1.1x")
    assert(formatNumber(1024+204, 1024, "x") == "1.1x")
    assert(formatNumber(1024+205, 1024, "x") == "1.2x")
    assert(formatNumber(2048-1, 1024, "x") == "1.9x")
    assert(formatNumber(2048, 1024, "x") == "2x")
    assert(formatNumber(10*1024-1, 1024, "x") == "9.9x")

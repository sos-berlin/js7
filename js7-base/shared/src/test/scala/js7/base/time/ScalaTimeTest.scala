...
final class ScalaTimeTest extends OurTestSuite:
  ...
  "Duration" - {
    ...
    "show" in:
      assert(0.s.show == "0s")
      assert(Duration(1, NANOSECONDS).show == "1ns")
      assert(Duration(12, NANOSECONDS).show == "12ns")
      assert(Duration(123, NANOSECONDS).show == "123ns")

      assert(Duration(1_000, NANOSECONDS).show == "1µs")
      assert(Duration(1_200, NANOSECONDS).show == "1.2µs")
      assert(Duration(123_456, NANOSECONDS).show == "123.456µs")

      assert(Duration(1_000_000, NANOSECONDS).show == "1ms")
      assert(Duration(1_200_000, NANOSECONDS).show == "1.2ms")
      assert(Duration(1_230_000, NANOSECONDS).show == "1.23ms")
      assert(Duration(1_234_000, NANOSECONDS).show == "1.234ms")
      assert(Duration(1_234_500, NANOSECONDS).show == "1.2345ms")
      assert(Duration(1_234_560, NANOSECONDS).show == "1.23456ms")
      assert(Duration(1_234_567, NANOSECONDS).show == "1.234567ms")
      assert(Duration(12_000_000, NANOSECONDS).show == "12ms")
      assert(Duration(123_456_789, NANOSECONDS).show == "123.456789ms")
      assert(Duration(1_000_000_000, NANOSECONDS).show == "1s")
      assert(Duration(1_234_000_000, NANOSECONDS).show == "1.234s")
      assert(Duration(1_234_567_890, NANOSECONDS).show == "1.23456789s")
      assert(Duration(12_000_000_000L, NANOSECONDS).show == "12s")
      assert(Duration(59_999_999_999L, NANOSECONDS).show == "59.999999999s")
      assert(Duration(60_000_000_000L, NANOSECONDS).show == "1minute")
      assert(Duration(60_000_000_001L, NANOSECONDS).show == "00:01:00.000000001")
      assert(Duration(599_123_456_789L, NANOSECONDS).show == "00:09:59.123456789")
      assert(Duration(3599_999_999_999L, NANOSECONDS).show == "00:59:59.999999999")
      assert(Duration(3600_000_000_000L, NANOSECONDS).show == "1h")
      assert(Duration(3723_444_555_666L, NANOSECONDS).show == "01:02:03.444555666")
      assert(Duration(86_399_999_999_999L, NANOSECONDS).show == "23:59:59.999999999")
      assert(Duration(86_400_000_000_000L, NANOSECONDS).show == "1d")
      assert(Duration(86_400_000_000_001L, NANOSECONDS).show == "1d00:00:00.000000001")
      assert((100.days + 1.nanos).show == "100d00:00:00.000000001")
      assert(Long.MaxValue.nanoseconds.show == "106751d23:47:16.854775807")
      assert((Long.MinValue + 1).nanoseconds.show == "-106751d23:47:16.854775807")

    "msPretty" in:
      assert(0.s.msPretty == "0ms")
      assert(Duration(1, NANOSECONDS).msPretty == "1ns")
      assert(Duration(990, NANOSECONDS).msPretty == "0.99µs")
      assert(Duration(999, NANOSECONDS).msPretty == "1µs")
    ...
    "pretty" in:
      ...
      assert(Duration(23, NANOSECONDS).pretty == "23ns")
      assert(Duration(123, NANOSECONDS).pretty == "0.123µs")
      assert(Duration(234, NANOSECONDS).pretty == "0.23µs")
      assert(Duration(1234, NANOSECONDS).pretty == "1.23µs")
      assert(Duration(2345, NANOSECONDS).pretty == "2.3µs")
      assert(Duration(12_345, NANOSECONDS).pretty == "12.3µs")
      assert(Duration(23_456, NANOSECONDS).pretty == "23µs")
      assert(Duration(123_456, NANOSECONDS).pretty == "0.123ms")
      assert(Duration(234_567, NANOSECONDS).pretty == "0.23ms")
      assert(Duration(1234_567, NANOSECONDS).pretty == "1.23ms")
      assert(Duration(2345_678, NANOSECONDS).pretty == "2.3ms")
      assert(Duration(12_345_678, NANOSECONDS).pretty == "12.3ms")
      assert(Duration(23_456_789, NANOSECONDS).pretty == "23ms")
      assert(Duration(123_456_789, NANOSECONDS).pretty == "0.123s")
      assert(Duration(234_567_890L, NANOSECONDS).pretty == "0.23s")
      assert(Duration(1234_567_890, NANOSECONDS).pretty == "1.23s")
      assert(Duration(2345_678_901L, NANOSECONDS).pretty == "2.3s")
      assert(Duration(12_345_678_901L, NANOSECONDS).pretty == "12.3s")
      assert(Duration(23_456_789_012L, NANOSECONDS).pretty == "23s")
      assert(Duration(123_456_789_012L, NANOSECONDS).pretty == "123s")
      assert(Duration(234_567_890_123L, NANOSECONDS).pretty == "3:54min")
      assert(Duration(1234_567_890_123L, NANOSECONDS).pretty == "20:34min")
      assert(Duration(2345_678_901_234L, NANOSECONDS).pretty == "39:05min")
      assert(Duration(12_345_678_901_234L, NANOSECONDS).pretty == "3:25h")
      ...
      assert(2990000000L.ns.pretty == "3s")
  ...
  "FiniteDuration" - {
    ...
    "roundToDigits" in:
      ...
      assert(1234.ms.roundToDigits(4) == 1234.ms)
      assert(1234.ms.roundToDigits(5) == 1234.ms)

      assert(123.µs.roundToDigits(1) == 100.µs)
      assert(123.µs.roundToDigits(2) == 120.µs)
      assert(123.µs.roundToDigits(3) == 123.µs)
      assert(123.µs.roundToDigits(4) == 123.µs)

      assert(9876.ms.roundToDigits(-1) == 10.s)
      assert(9876.ms.roundToDigits(0) == 10.s)
      assert(9876.ms.roundToDigits(1) == 10.s)
      assert(9876.ms.roundToDigits(2) == 9900.ms)

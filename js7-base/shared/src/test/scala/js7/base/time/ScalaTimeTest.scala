...
final class ScalaTimeTest extends OurTestSuite:
  ...
  "Duration" - {
    ...
    "show" in:
      ...
      assert(Duration(60_000_000_000L, NANOSECONDS).show == "00:01:00")
      ...
      assert(Duration(3600_000_000_000L, NANOSECONDS).show == "01:00:00")
      ...
      assert(Duration(86_400_000_000_000L, NANOSECONDS).show == "1d00:00:00")
